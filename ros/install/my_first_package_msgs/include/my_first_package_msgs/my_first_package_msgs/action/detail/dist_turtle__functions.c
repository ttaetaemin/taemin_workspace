...
my_first_package_msgs__action__DistTurtle_Goal__create(void)
{
  ...
  my_first_package_msgs__action__DistTurtle_Goal * msg = (my_first_package_msgs__action__DistTurtle_Goal *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_first_package_msgs__action__DistTurtle_Goal));
  bool success = my_first_package_msgs__action__DistTurtle_Goal__init(msg);
  if (!success) {
...
my_first_package_msgs__action__DistTurtle_Goal__destroy(my_first_package_msgs__action__DistTurtle_Goal * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    my_first_package_msgs__action__DistTurtle_Goal__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
my_first_package_msgs__action__DistTurtle_Goal__Sequence__init(my_first_package_msgs__action__DistTurtle_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_Goal * data = NULL;

  if (size) {
    data = (my_first_package_msgs__action__DistTurtle_Goal *)allocator.zero_allocate(size, sizeof(my_first_package_msgs__action__DistTurtle_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_first_package_msgs__action__DistTurtle_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        my_first_package_msgs__action__DistTurtle_Goal__fini(&data[i - 1]);
      }
...
my_first_package_msgs__action__DistTurtle_Goal__Sequence__fini(my_first_package_msgs__action__DistTurtle_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      my_first_package_msgs__action__DistTurtle_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_Goal__Sequence * array = (my_first_package_msgs__action__DistTurtle_Goal__Sequence *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_first_package_msgs__action__DistTurtle_Goal__Sequence__init(array, size);
  if (!success) {
...
my_first_package_msgs__action__DistTurtle_Goal__Sequence__destroy(my_first_package_msgs__action__DistTurtle_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_first_package_msgs__action__DistTurtle_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_first_package_msgs__action__DistTurtle_Goal__Sequence__are_equal(const my_first_package_msgs__action__DistTurtle_Goal__Sequence * lhs, const my_first_package_msgs__action__DistTurtle_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_first_package_msgs__action__DistTurtle_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_first_package_msgs__action__DistTurtle_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_first_package_msgs__action__DistTurtle_Goal * data =
      (my_first_package_msgs__action__DistTurtle_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_first_package_msgs__action__DistTurtle_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_first_package_msgs__action__DistTurtle_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_Result * msg = (my_first_package_msgs__action__DistTurtle_Result *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_first_package_msgs__action__DistTurtle_Result));
  bool success = my_first_package_msgs__action__DistTurtle_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_Result__destroy(my_first_package_msgs__action__DistTurtle_Result * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    my_first_package_msgs__action__DistTurtle_Result__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
my_first_package_msgs__action__DistTurtle_Result__Sequence__init(my_first_package_msgs__action__DistTurtle_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_Result * data = NULL;

  if (size) {
    data = (my_first_package_msgs__action__DistTurtle_Result *)allocator.zero_allocate(size, sizeof(my_first_package_msgs__action__DistTurtle_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_first_package_msgs__action__DistTurtle_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_first_package_msgs__action__DistTurtle_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_first_package_msgs__action__DistTurtle_Result__Sequence__fini(my_first_package_msgs__action__DistTurtle_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_first_package_msgs__action__DistTurtle_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_Result__Sequence * array = (my_first_package_msgs__action__DistTurtle_Result__Sequence *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_first_package_msgs__action__DistTurtle_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_Result__Sequence__destroy(my_first_package_msgs__action__DistTurtle_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_first_package_msgs__action__DistTurtle_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_first_package_msgs__action__DistTurtle_Result__Sequence__are_equal(const my_first_package_msgs__action__DistTurtle_Result__Sequence * lhs, const my_first_package_msgs__action__DistTurtle_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_first_package_msgs__action__DistTurtle_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_first_package_msgs__action__DistTurtle_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_first_package_msgs__action__DistTurtle_Result * data =
      (my_first_package_msgs__action__DistTurtle_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_first_package_msgs__action__DistTurtle_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_first_package_msgs__action__DistTurtle_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_Feedback * msg = (my_first_package_msgs__action__DistTurtle_Feedback *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_first_package_msgs__action__DistTurtle_Feedback));
  bool success = my_first_package_msgs__action__DistTurtle_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_Feedback__destroy(my_first_package_msgs__action__DistTurtle_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    my_first_package_msgs__action__DistTurtle_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
my_first_package_msgs__action__DistTurtle_Feedback__Sequence__init(my_first_package_msgs__action__DistTurtle_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_Feedback * data = NULL;

  if (size) {
    data = (my_first_package_msgs__action__DistTurtle_Feedback *)allocator.zero_allocate(size, sizeof(my_first_package_msgs__action__DistTurtle_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_first_package_msgs__action__DistTurtle_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_first_package_msgs__action__DistTurtle_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_first_package_msgs__action__DistTurtle_Feedback__Sequence__fini(my_first_package_msgs__action__DistTurtle_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_first_package_msgs__action__DistTurtle_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_Feedback__Sequence * array = (my_first_package_msgs__action__DistTurtle_Feedback__Sequence *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_first_package_msgs__action__DistTurtle_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_Feedback__Sequence__destroy(my_first_package_msgs__action__DistTurtle_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_first_package_msgs__action__DistTurtle_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_first_package_msgs__action__DistTurtle_Feedback__Sequence__are_equal(const my_first_package_msgs__action__DistTurtle_Feedback__Sequence * lhs, const my_first_package_msgs__action__DistTurtle_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_first_package_msgs__action__DistTurtle_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_first_package_msgs__action__DistTurtle_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_first_package_msgs__action__DistTurtle_Feedback * data =
      (my_first_package_msgs__action__DistTurtle_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_first_package_msgs__action__DistTurtle_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_first_package_msgs__action__DistTurtle_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_first_package_msgs__action__DistTurtle_SendGoal_Request__init(my_first_package_msgs__action__DistTurtle_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    my_first_package_msgs__action__DistTurtle_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!my_first_package_msgs__action__DistTurtle_Goal__init(&msg->goal)) {
    my_first_package_msgs__action__DistTurtle_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
my_first_package_msgs__action__DistTurtle_SendGoal_Request__fini(my_first_package_msgs__action__DistTurtle_SendGoal_Request * msg)
{
  ...
  // goal
  my_first_package_msgs__action__DistTurtle_Goal__fini(&msg->goal);
}
...
my_first_package_msgs__action__DistTurtle_SendGoal_Request__are_equal(const my_first_package_msgs__action__DistTurtle_SendGoal_Request * lhs, const my_first_package_msgs__action__DistTurtle_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!my_first_package_msgs__action__DistTurtle_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_SendGoal_Request * msg = (my_first_package_msgs__action__DistTurtle_SendGoal_Request *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_first_package_msgs__action__DistTurtle_SendGoal_Request));
  bool success = my_first_package_msgs__action__DistTurtle_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence__init(my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_SendGoal_Request * data = NULL;

  if (size) {
    data = (my_first_package_msgs__action__DistTurtle_SendGoal_Request *)allocator.zero_allocate(size, sizeof(my_first_package_msgs__action__DistTurtle_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_first_package_msgs__action__DistTurtle_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_first_package_msgs__action__DistTurtle_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence__fini(my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_first_package_msgs__action__DistTurtle_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence * array = (my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence__destroy(my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence__are_equal(const my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence * lhs, const my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_first_package_msgs__action__DistTurtle_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_first_package_msgs__action__DistTurtle_SendGoal_Request * data =
      (my_first_package_msgs__action__DistTurtle_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_first_package_msgs__action__DistTurtle_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_first_package_msgs__action__DistTurtle_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_first_package_msgs__action__DistTurtle_SendGoal_Response__init(my_first_package_msgs__action__DistTurtle_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    my_first_package_msgs__action__DistTurtle_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_SendGoal_Response * msg = (my_first_package_msgs__action__DistTurtle_SendGoal_Response *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_first_package_msgs__action__DistTurtle_SendGoal_Response));
  bool success = my_first_package_msgs__action__DistTurtle_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence__init(my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_SendGoal_Response * data = NULL;

  if (size) {
    data = (my_first_package_msgs__action__DistTurtle_SendGoal_Response *)allocator.zero_allocate(size, sizeof(my_first_package_msgs__action__DistTurtle_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_first_package_msgs__action__DistTurtle_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_first_package_msgs__action__DistTurtle_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence__fini(my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_first_package_msgs__action__DistTurtle_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence * array = (my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence__destroy(my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence__are_equal(const my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence * lhs, const my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_first_package_msgs__action__DistTurtle_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_first_package_msgs__action__DistTurtle_SendGoal_Response * data =
      (my_first_package_msgs__action__DistTurtle_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_first_package_msgs__action__DistTurtle_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_first_package_msgs__action__DistTurtle_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_first_package_msgs__action__DistTurtle_SendGoal_Event__init(my_first_package_msgs__action__DistTurtle_SendGoal_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    my_first_package_msgs__action__DistTurtle_SendGoal_Event__fini(msg);
    return false;
  }
  // request
  if (!my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence__init(&msg->request, 0)) {
    my_first_package_msgs__action__DistTurtle_SendGoal_Event__fini(msg);
    return false;
  }
  // response
  if (!my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence__init(&msg->response, 0)) {
    my_first_package_msgs__action__DistTurtle_SendGoal_Event__fini(msg);
    return false;
  }
  return true;
...
my_first_package_msgs__action__DistTurtle_SendGoal_Event__fini(my_first_package_msgs__action__DistTurtle_SendGoal_Event * msg)
{
  ...
  // request
  my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence__fini(&msg->request);
  // response
  my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence__fini(&msg->response);
}
...
my_first_package_msgs__action__DistTurtle_SendGoal_Event__are_equal(const my_first_package_msgs__action__DistTurtle_SendGoal_Event * lhs, const my_first_package_msgs__action__DistTurtle_SendGoal_Event * rhs)
{
  ...
  // request
  if (!my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence__are_equal(
  ...
  my_first_package_msgs__action__DistTurtle_SendGoal_Event * output)
{
  ...
  // request
  if (!my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_SendGoal_Event * msg = (my_first_package_msgs__action__DistTurtle_SendGoal_Event *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_SendGoal_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_first_package_msgs__action__DistTurtle_SendGoal_Event));
  bool success = my_first_package_msgs__action__DistTurtle_SendGoal_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_SendGoal_Event__Sequence__init(my_first_package_msgs__action__DistTurtle_SendGoal_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_SendGoal_Event * data = NULL;

  if (size) {
    data = (my_first_package_msgs__action__DistTurtle_SendGoal_Event *)allocator.zero_allocate(size, sizeof(my_first_package_msgs__action__DistTurtle_SendGoal_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_first_package_msgs__action__DistTurtle_SendGoal_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_first_package_msgs__action__DistTurtle_SendGoal_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_first_package_msgs__action__DistTurtle_SendGoal_Event__Sequence__fini(my_first_package_msgs__action__DistTurtle_SendGoal_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_first_package_msgs__action__DistTurtle_SendGoal_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_SendGoal_Event__Sequence * array = (my_first_package_msgs__action__DistTurtle_SendGoal_Event__Sequence *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_SendGoal_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_first_package_msgs__action__DistTurtle_SendGoal_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_SendGoal_Event__Sequence__destroy(my_first_package_msgs__action__DistTurtle_SendGoal_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_first_package_msgs__action__DistTurtle_SendGoal_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_first_package_msgs__action__DistTurtle_SendGoal_Event__Sequence__are_equal(const my_first_package_msgs__action__DistTurtle_SendGoal_Event__Sequence * lhs, const my_first_package_msgs__action__DistTurtle_SendGoal_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_SendGoal_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_first_package_msgs__action__DistTurtle_SendGoal_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_first_package_msgs__action__DistTurtle_SendGoal_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_first_package_msgs__action__DistTurtle_SendGoal_Event * data =
      (my_first_package_msgs__action__DistTurtle_SendGoal_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_first_package_msgs__action__DistTurtle_SendGoal_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_first_package_msgs__action__DistTurtle_SendGoal_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_SendGoal_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_first_package_msgs__action__DistTurtle_GetResult_Request__init(my_first_package_msgs__action__DistTurtle_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    my_first_package_msgs__action__DistTurtle_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_GetResult_Request * msg = (my_first_package_msgs__action__DistTurtle_GetResult_Request *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_first_package_msgs__action__DistTurtle_GetResult_Request));
  bool success = my_first_package_msgs__action__DistTurtle_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence__init(my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_GetResult_Request * data = NULL;

  if (size) {
    data = (my_first_package_msgs__action__DistTurtle_GetResult_Request *)allocator.zero_allocate(size, sizeof(my_first_package_msgs__action__DistTurtle_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_first_package_msgs__action__DistTurtle_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_first_package_msgs__action__DistTurtle_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence__fini(my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_first_package_msgs__action__DistTurtle_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence * array = (my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence__destroy(my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence__are_equal(const my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence * lhs, const my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_first_package_msgs__action__DistTurtle_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_first_package_msgs__action__DistTurtle_GetResult_Request * data =
      (my_first_package_msgs__action__DistTurtle_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_first_package_msgs__action__DistTurtle_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_first_package_msgs__action__DistTurtle_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_first_package_msgs__action__DistTurtle_GetResult_Response__init(my_first_package_msgs__action__DistTurtle_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!my_first_package_msgs__action__DistTurtle_Result__init(&msg->result)) {
    my_first_package_msgs__action__DistTurtle_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
my_first_package_msgs__action__DistTurtle_GetResult_Response__fini(my_first_package_msgs__action__DistTurtle_GetResult_Response * msg)
{
  ...
  // status
  // result
  my_first_package_msgs__action__DistTurtle_Result__fini(&msg->result);
}
...
my_first_package_msgs__action__DistTurtle_GetResult_Response__are_equal(const my_first_package_msgs__action__DistTurtle_GetResult_Response * lhs, const my_first_package_msgs__action__DistTurtle_GetResult_Response * rhs)
{
  ...
  // result
  if (!my_first_package_msgs__action__DistTurtle_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_GetResult_Response * msg = (my_first_package_msgs__action__DistTurtle_GetResult_Response *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_first_package_msgs__action__DistTurtle_GetResult_Response));
  bool success = my_first_package_msgs__action__DistTurtle_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence__init(my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_GetResult_Response * data = NULL;

  if (size) {
    data = (my_first_package_msgs__action__DistTurtle_GetResult_Response *)allocator.zero_allocate(size, sizeof(my_first_package_msgs__action__DistTurtle_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_first_package_msgs__action__DistTurtle_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_first_package_msgs__action__DistTurtle_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence__fini(my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_first_package_msgs__action__DistTurtle_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence * array = (my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence__destroy(my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence__are_equal(const my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence * lhs, const my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_first_package_msgs__action__DistTurtle_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_first_package_msgs__action__DistTurtle_GetResult_Response * data =
      (my_first_package_msgs__action__DistTurtle_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_first_package_msgs__action__DistTurtle_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_first_package_msgs__action__DistTurtle_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_first_package_msgs__action__DistTurtle_GetResult_Event__init(my_first_package_msgs__action__DistTurtle_GetResult_Event * msg)
{
  ...
  // info
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    my_first_package_msgs__action__DistTurtle_GetResult_Event__fini(msg);
    return false;
  }
  // request
  if (!my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence__init(&msg->request, 0)) {
    my_first_package_msgs__action__DistTurtle_GetResult_Event__fini(msg);
    return false;
  }
  // response
  if (!my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence__init(&msg->response, 0)) {
    my_first_package_msgs__action__DistTurtle_GetResult_Event__fini(msg);
    return false;
  }
  return true;
...
my_first_package_msgs__action__DistTurtle_GetResult_Event__fini(my_first_package_msgs__action__DistTurtle_GetResult_Event * msg)
{
  ...
  service_msgs__msg__ServiceEventInfo__fini(&msg->info);
  // request
  my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence__fini(&msg->request);
  // response
  my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence__fini(&msg->response);
}
...
my_first_package_msgs__action__DistTurtle_GetResult_Event__are_equal(const my_first_package_msgs__action__DistTurtle_GetResult_Event * lhs, const my_first_package_msgs__action__DistTurtle_GetResult_Event * rhs)
{
  ...
  // request
  if (!my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
  ...
  my_first_package_msgs__action__DistTurtle_GetResult_Event * output)
{
  ...
  // request
  if (!my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_GetResult_Event * msg = (my_first_package_msgs__action__DistTurtle_GetResult_Event *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_GetResult_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_first_package_msgs__action__DistTurtle_GetResult_Event));
  bool success = my_first_package_msgs__action__DistTurtle_GetResult_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_GetResult_Event__Sequence__init(my_first_package_msgs__action__DistTurtle_GetResult_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_GetResult_Event * data = NULL;

  if (size) {
    data = (my_first_package_msgs__action__DistTurtle_GetResult_Event *)allocator.zero_allocate(size, sizeof(my_first_package_msgs__action__DistTurtle_GetResult_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_first_package_msgs__action__DistTurtle_GetResult_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_first_package_msgs__action__DistTurtle_GetResult_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_first_package_msgs__action__DistTurtle_GetResult_Event__Sequence__fini(my_first_package_msgs__action__DistTurtle_GetResult_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_first_package_msgs__action__DistTurtle_GetResult_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_GetResult_Event__Sequence * array = (my_first_package_msgs__action__DistTurtle_GetResult_Event__Sequence *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_GetResult_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_first_package_msgs__action__DistTurtle_GetResult_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_GetResult_Event__Sequence__destroy(my_first_package_msgs__action__DistTurtle_GetResult_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_first_package_msgs__action__DistTurtle_GetResult_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_first_package_msgs__action__DistTurtle_GetResult_Event__Sequence__are_equal(const my_first_package_msgs__action__DistTurtle_GetResult_Event__Sequence * lhs, const my_first_package_msgs__action__DistTurtle_GetResult_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_GetResult_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_first_package_msgs__action__DistTurtle_GetResult_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_first_package_msgs__action__DistTurtle_GetResult_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_first_package_msgs__action__DistTurtle_GetResult_Event * data =
      (my_first_package_msgs__action__DistTurtle_GetResult_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_first_package_msgs__action__DistTurtle_GetResult_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_first_package_msgs__action__DistTurtle_GetResult_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_GetResult_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_first_package_msgs__action__DistTurtle_FeedbackMessage__init(my_first_package_msgs__action__DistTurtle_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    my_first_package_msgs__action__DistTurtle_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!my_first_package_msgs__action__DistTurtle_Feedback__init(&msg->feedback)) {
    my_first_package_msgs__action__DistTurtle_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
my_first_package_msgs__action__DistTurtle_FeedbackMessage__fini(my_first_package_msgs__action__DistTurtle_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  my_first_package_msgs__action__DistTurtle_Feedback__fini(&msg->feedback);
}
...
my_first_package_msgs__action__DistTurtle_FeedbackMessage__are_equal(const my_first_package_msgs__action__DistTurtle_FeedbackMessage * lhs, const my_first_package_msgs__action__DistTurtle_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!my_first_package_msgs__action__DistTurtle_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_FeedbackMessage * msg = (my_first_package_msgs__action__DistTurtle_FeedbackMessage *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_first_package_msgs__action__DistTurtle_FeedbackMessage));
  bool success = my_first_package_msgs__action__DistTurtle_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_FeedbackMessage__Sequence__init(my_first_package_msgs__action__DistTurtle_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_FeedbackMessage * data = NULL;

  if (size) {
    data = (my_first_package_msgs__action__DistTurtle_FeedbackMessage *)allocator.zero_allocate(size, sizeof(my_first_package_msgs__action__DistTurtle_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_first_package_msgs__action__DistTurtle_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_first_package_msgs__action__DistTurtle_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_first_package_msgs__action__DistTurtle_FeedbackMessage__Sequence__fini(my_first_package_msgs__action__DistTurtle_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_first_package_msgs__action__DistTurtle_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__action__DistTurtle_FeedbackMessage__Sequence * array = (my_first_package_msgs__action__DistTurtle_FeedbackMessage__Sequence *)allocator.allocate(sizeof(my_first_package_msgs__action__DistTurtle_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_first_package_msgs__action__DistTurtle_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_first_package_msgs__action__DistTurtle_FeedbackMessage__Sequence__destroy(my_first_package_msgs__action__DistTurtle_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_first_package_msgs__action__DistTurtle_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_first_package_msgs__action__DistTurtle_FeedbackMessage__Sequence__are_equal(const my_first_package_msgs__action__DistTurtle_FeedbackMessage__Sequence * lhs, const my_first_package_msgs__action__DistTurtle_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_first_package_msgs__action__DistTurtle_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_first_package_msgs__action__DistTurtle_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_first_package_msgs__action__DistTurtle_FeedbackMessage * data =
      (my_first_package_msgs__action__DistTurtle_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_first_package_msgs__action__DistTurtle_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_first_package_msgs__action__DistTurtle_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_first_package_msgs__action__DistTurtle_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
