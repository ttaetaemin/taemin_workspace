...
bool cdr_serialize_my_first_package_msgs__msg__CmdAndPoseVel(
  const my_first_package_msgs__msg__CmdAndPoseVel * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_first_package_msgs
bool cdr_deserialize_my_first_package_msgs__msg__CmdAndPoseVel(
  eprosima::fastcdr::Cdr & cdr,
  my_first_package_msgs__msg__CmdAndPoseVel * ros_message)
{
  // Field name: cmd_vel_linear
  {
    cdr >> ros_message->cmd_vel_linear;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_first_package_msgs
bool cdr_serialize_key_my_first_package_msgs__msg__CmdAndPoseVel(
  const my_first_package_msgs__msg__CmdAndPoseVel * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: cmd_vel_linear
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_first_package_msgs
size_t get_serialized_size_key_my_first_package_msgs__msg__CmdAndPoseVel(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CmdAndPoseVel__ros_msg_type * ros_message = static_cast<const _CmdAndPoseVel__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_first_package_msgs
size_t max_serialized_size_key_my_first_package_msgs__msg__CmdAndPoseVel(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const my_first_package_msgs__msg__CmdAndPoseVel * ros_message = static_cast<const my_first_package_msgs__msg__CmdAndPoseVel *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_my_first_package_msgs__msg__CmdAndPoseVel(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  my_first_package_msgs__msg__CmdAndPoseVel * ros_message = static_cast<my_first_package_msgs__msg__CmdAndPoseVel *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_my_first_package_msgs__msg__CmdAndPoseVel(cdr, ros_message);
}
