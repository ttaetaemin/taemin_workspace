...
enum
{
  my_first_package_msgs__action__DistTurtle_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  my_first_package_msgs__action__DistTurtle_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/DistTurtle in the package my_first_package_msgs.
typedef struct my_first_package_msgs__action__DistTurtle_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  my_first_package_msgs__action__DistTurtle_SendGoal_Request__Sequence request;
  my_first_package_msgs__action__DistTurtle_SendGoal_Response__Sequence response;
} my_first_package_msgs__action__DistTurtle_SendGoal_Event;

// Struct for a sequence of my_first_package_msgs__action__DistTurtle_SendGoal_Event.
typedef struct my_first_package_msgs__action__DistTurtle_SendGoal_Event__Sequence
{
...
enum
{
  my_first_package_msgs__action__DistTurtle_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  my_first_package_msgs__action__DistTurtle_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/DistTurtle in the package my_first_package_msgs.
typedef struct my_first_package_msgs__action__DistTurtle_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  my_first_package_msgs__action__DistTurtle_GetResult_Request__Sequence request;
  my_first_package_msgs__action__DistTurtle_GetResult_Response__Sequence response;
} my_first_package_msgs__action__DistTurtle_GetResult_Event;

// Struct for a sequence of my_first_package_msgs__action__DistTurtle_GetResult_Event.
typedef struct my_first_package_msgs__action__DistTurtle_GetResult_Event__Sequence
{
