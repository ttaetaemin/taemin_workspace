...
enum
{
  my_first_package_msgs__srv__MultiSpawn_Event__request__MAX_SIZE = 1
};
// response
enum
{
  my_first_package_msgs__srv__MultiSpawn_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/MultiSpawn in the package my_first_package_msgs.
typedef struct my_first_package_msgs__srv__MultiSpawn_Event
{
  service_msgs__msg__ServiceEventInfo info;
  my_first_package_msgs__srv__MultiSpawn_Request__Sequence request;
  my_first_package_msgs__srv__MultiSpawn_Response__Sequence response;
} my_first_package_msgs__srv__MultiSpawn_Event;

// Struct for a sequence of my_first_package_msgs__srv__MultiSpawn_Event.
typedef struct my_first_package_msgs__srv__MultiSpawn_Event__Sequence
{
